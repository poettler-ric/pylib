...
raindata = {'root':r'/media/iwbworkstation/My Passport/Dissertation/3_Hydrology/Muerz/basedata/INCA_DATA/free_Data/netcdf_files/RR',
            'projection':'epsg:31287',
            'naming':'Muerz_RR_%Y%m%d_%H%M.tif',
            'timestep_secs':'3600'}
tempdata = {'root':r'/media/iwbworkstation/My Passport/Dissertation/3_Hydrology/Muerz/basedata/INCA_DATA/free_Data/netcdf_files/TT',
            'projection':'epsg:31287',
            'naming':'Muerz_RR_%Y%m%d_%H%M.tif',
            'timestep_secs':'3600'}
raddata = {'root':r'/media/iwbworkstation/My Passport/Dissertation/3_Hydrology/Muerz/basedata/INCA_DATA/free_Data/netcdf_files/GL',
            'projection':'epsg:31287',
            'naming':'Muerz_RR_%Y%m%d_%H%M.tif',
            'timestep_secs':'3600'}
...
zamgnc = Series2nc(resultfolder,start_date,end_date,raindata,tempdata,outproj,bounds,resolution,pathGL = raddata,timestep = time_step)
